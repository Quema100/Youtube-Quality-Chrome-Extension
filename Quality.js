        ...
        if(topelement){
            ...
            if(secondelement){
                ...
                for (const spanElement of spanElements) {
                    ...
                    } else if ((spanElement.textContent.trim() === '1080p Premium HDEnhanced bitrate') === (spanElement.textContent.trim() === '1080p HD' || spanElement.textContent.trim() === '1080p60 HD')) {
                        spanElement.click();
                ...
                for (const span of spanTag) {
                    if (span.textContent.includes('2160p')) {
                       ...
                       break; // 2160p를 찾았으면 더 이상 탐색하지 않고 반복문을 종료합니다.
                        ...
                        span.click();
                        break; // 2160p와 1440p를 찾지 못한 경우 1080p를 찾았으면 더 이상 탐색하지 않고 반복문을 종료합니다.
                    } else if (span.textContent.trim() === '1080p Premium HDEnhanced bitrate') {
                        span.click();
                        break; // 2160p와 1440p, 1080p를 찾지 못한 경우 1080p Premium를 찾았으면 더 이상 탐색하지 않고 반복문을 종료합니다
